...
public class LogFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		System.out.println("요청처리 시작 :" + startTime);
		System.out.println("요청처리 완료 :" + endTime);
		System.out.println("요청처리 소요시간 :" + duration + "ms");
		System.out.println("========== ========= ========");
		
		writer.println("클라이언트 IP :" + clientIP);
		writer.println("URL :" + url);
		writer.println("요청 처리 시작 :"  + startTime );
		writer.println("요청처리 완료 :" +endTime );
		writer.println("요청처리 소요시간 :" + + duration + "ms");
		writer.println("========== ========= ========");
	}

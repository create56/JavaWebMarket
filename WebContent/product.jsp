...
<body>
	...
	<script>
		//사용자가 이페잊로 접근하기 위해 주소 표시줄에 입력한 프로토콜 명
		// http 또는 https
		var protocol = location.protocol;
		// 사용자가 이페이지로 접근하기 위해 주소 표시줄에 입력한 도메인 명
		var domain = location.hostname;
		//  사용자가 이 페이지로 접근하기 위해 주소 표시줄에 입력한 포트 번호
		// 단, 포트번호는 없을 수 있음 / 포트 번호가 없다는건 프로토콜의 기본 포트 번호를 사용했다는 것

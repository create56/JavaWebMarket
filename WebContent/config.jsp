...
<%!
	...
	String PRODUCTS_PAGE_URL = "/WebMarket/product/list.jsp?active=products";
	String PRODUCT_ADD_PAGE_URL = "/WebMarket/product/add.jsp?active=addProduct";
	String PRODUCT_PAGE_URL = "/WebMarket/product/info.jsp?active=products";
	...
	String ADD_TO_CART_PROCESS_URL = "/WebMarker/cart/add";
